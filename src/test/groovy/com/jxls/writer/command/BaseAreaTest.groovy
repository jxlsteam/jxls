...
class BaseAreaTest extends Specification{
    ...
    def "test applyAt for simple area"(){
        ...
        when:
            area.applyAt(new Pos("sheet1", 4, 3), context)
        then:
            1 * transformer.transform(new Pos("sheet1",1, 1), new Pos("sheet1",4, 3), context)
            1 * transformer.transform(new Pos("sheet1",2, 1), new Pos("sheet1",5, 3), context)
            1 * transformer.transform(new Pos("sheet1",3, 1), new Pos("sheet1",6, 3), context)
            1 * transformer.transform(new Pos("sheet1",1, 2), new Pos("sheet1",4, 4), context)
            1 * transformer.transform(new Pos("sheet1",2, 2), new Pos("sheet1",5, 4), context)
            1 * transformer.transform(new Pos("sheet1",3, 2), new Pos("sheet1",6, 4), context)
            0 * _._
    }
    ...
    def "test applyAt for another sheet"(){
        ...
        then:
            1 * transformer.transform(new Pos("sheet1",1, 1), new Pos("sheet2", 4, 3), context)
            1 * transformer.transform(new Pos("sheet1",2, 1), new Pos("sheet2", 5, 3), context)
            1 * transformer.transform(new Pos("sheet1",3, 1), new Pos("sheet2", 6, 3), context)
            1 * transformer.transform(new Pos("sheet1",1, 2), new Pos("sheet2", 4, 4), context)
            1 * transformer.transform(new Pos("sheet1",2, 2), new Pos("sheet2", 5, 4), context)
            1 * transformer.transform(new Pos("sheet1",3, 2), new Pos("sheet2", 6, 4), context)
            0 * _._
    }
    ...
    def "test applyAt with two inner commands"(){
        ...
        then:
            1 * innerCommand1.applyAt(new Pos("sheet1",7, 5), context) >> new Size(3,6)
            1 * innerCommand2.applyAt(new Pos("sheet1",14, 4), context) >> new Size(4,3)
            1 * transformer.transform(new Pos("sheet1",1, 1), new Pos("sheet1",5, 4), context)
            1 * transformer.transform(new Pos("sheet1",6, 2), new Pos("sheet1",13, 5), context)
            1 * transformer.transform(new Pos("sheet1",6, 3), new Pos("sheet1",13, 6), context)
            1 * transformer.transform(new Pos("sheet1",3, 5), new Pos("sheet1",7, 9), context)
            1 * transformer.transform(new Pos("sheet1",14, 2), new Pos("sheet1",19, 5), context)
            1 * transformer.transform(new Pos("sheet1",14, 1), new Pos("sheet1",19, 4), context)
    }
    ...
    def "test applyAt multiple times"(){
        given:
            ...
            context2.putVar("x", 2)
        when:
            area.applyAt(new Pos("sheet1",2, 2), context1)
            area.applyAt(new Pos("sheet1",10, 2), context2)
        then:
            1 * transformer.transform(new Pos("sheet1",1, 1), new Pos("sheet1",2, 2), context1)
            1 * transformer.transform(new Pos("sheet1",1, 2), new Pos("sheet1",2, 3), context1)
            1 * transformer.transform(new Pos("sheet1",1, 1), new Pos("sheet1",10, 2), context2)
            1 * transformer.transform(new Pos("sheet1",1, 2), new Pos("sheet1",10, 3), context2)
            0 * _._
    }
    ...
    def "test formulas transformation"(){
        ...
        then:
            ...
            1 * transformer.getTargetPos(new Pos("sheet1",2,1)) >> [new Pos("sheet1!C5")]
            1 * transformer.getTargetPos(new Pos("sheet1",1,1)) >> [new Pos("sheet2",11,12)]

            1 * transformer.getTargetPos(new Pos("sheet1",19,3)) >> [new Pos("sheet1!K10")]
            1 * transformer.getTargetPos(new Pos("sheet1",29,4)) >> [new Pos("sheet1!I20")]
