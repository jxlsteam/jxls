...
import com.jxls.plus.area.CommandData;
...
/**
 * Builds {@link com.jxls.plus.area.XlsArea} from excel comments in the excel template
 ...
 * "jx:each" - {@link com.jxls.plus.command.EachCommand}
 ...
 *
 * Here we define {@link com.jxls.plus.command.EachCommand} with items attribute set to 'department.staff' and var attribute set to 'employee'.
...
public class XlsCommentAreaBuilder implements AreaBuilder {
    ...
    /**
     * Builds a list of {@link com.jxls.plus.area.XlsArea} objects defined by top level AreaCommand markup ("jx:area")
