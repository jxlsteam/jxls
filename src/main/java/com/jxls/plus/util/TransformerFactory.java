...
public class TransformerFactory {
    public static final String POI_CLASS_NAME = "com.jxls.plus.transform.poi.PoiTransformer";
    public static final String JEXCEL_CLASS_NAME = "com.jxls.plus.transform.jexcel.JexcelTransformer";
