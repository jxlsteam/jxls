...
- [#17 Multi-sheet template lose image](https://github.com/jxlsteam/jxls/issues/17)
...
* JxlsTester for writing template based testcases. See [Jxls source page](sourcecode.html) for more information.
