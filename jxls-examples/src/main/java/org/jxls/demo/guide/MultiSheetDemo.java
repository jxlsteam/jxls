 ...
 */
public class MultiSheetDemo {
    private static Logger logger = LoggerFactory.getLogger(MultiSheetDemo.class);

    public static void main(String[] args) throws ParseException, IOException {
        logger.info("Running Multi Sheet demo");
        List<Employee> employees = generateSampleEmployeeData();
        try(InputStream is = MultiSheetDemo.class.getResourceAsStream("multisheet_template.xls")) {
